...
import com.ssafy.attraction.model.AttractionResult;
	...
	public ResponseEntity<?> attractionlist(@RequestBody AttractionSearchDto attractionSearchDto) {
		...
		try {
			...
			if (list != null && !list.isEmpty()) {
				...
				return new ResponseEntity<AttractionResult>(new AttractionResult("fail", "NO RESULT"), HttpStatus.OK);
			}
		} catch (Exception e) {
			System.out.println(e.getMessage());
			return new ResponseEntity<AttractionResult>(new AttractionResult("fail", "NO LIST"), HttpStatus.OK);
		}
	}
